...
public interface TransactionRepository extends JpaRepository<Transaction, Long> {
    ...
    @Query("SELECT DISTINCT t FROM Transaction t JOIN User u ON t.user=u WHERE " +
    ...
    @Query("SELECT DISTINCT SUM(t.value) FROM Transaction t JOIN User u ON t.user=u  WHERE " +
            "u.username = :username")
